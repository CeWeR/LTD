function run(msg)
	...
	elseif msg.text == "ارتباط با ما" or msg.text == "درباره ما" or msg.text:lower() == "about" then
		about_txt = "*Contributive Robot* v"..bot_version.."\n`رباتی منحصر به فرد و رایگان برای مدیران کانال ها و افرادی که میخواهند خاص و متفاوت باشند.\nامکانات ربات:`\n   - ساخت کلید شیشه ای برای کانال\n   - قرار دادن لینک روی متن، هایپر لینک\n   - نوشتن متن با فونتهای مختلف\n   - تبدیل ویس و فایل صوتی به یکدیگر\n   - و...\n\n`محصولی از تیم قدرتمند کمک کننده.`\nبرنامه نویس: [  مرتضی رجب زاده](https://telegram.me/morteza4718)\nطراح و گرافیست: [محمد  ](https://telegram.me/Joker001001)"
		about_key = {{{text = "کانال تیم کمک کننده" , url = "https://telegram.me/Contributive"}},{{text = "مرتضی رجب زاده " , url = "https://telegram.me/morteza4718"}}}
